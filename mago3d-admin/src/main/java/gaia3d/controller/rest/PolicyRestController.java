...
public class PolicyRestController {
	...
	@PostMapping(value = "/social-signin/{policyId:[0-9]+}")
	public Map<String, Object> updateSocialSignin(@Valid Policy policy, @PathVariable Long policyId, BindingResult bindingResult) {
		Map<String, Object> result = new HashMap<>();
		String errorCode = null;
		String message = null;
		...
		policy.setPolicyId(policyId);
		policyService.updatePolicySocialSignin(policy);
		int statusCode = HttpStatus.OK.value();
