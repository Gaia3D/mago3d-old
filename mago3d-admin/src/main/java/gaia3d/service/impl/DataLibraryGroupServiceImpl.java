...
import gaia3d.persistence.DataLibraryGroupMapper;
...
public class DataLibraryGroupServiceImpl implements DataLibraryGroupService {
	 ...
	 * @param dataLibraryGroupKey
	 * @return
	 */
	@Transactional(readOnly = true)
	public DataLibraryGroup getDataLibraryGroupByKey(String dataLibraryGroupKey) {
		return dataLibraryGroupMapper.getDataLibraryGroupByKey(dataLibraryGroupKey);
	}
