...
public class SimulationPm25 implements SimulationJsonImporter {
    ...
    public Path getJsonPath() {
        String serviceDir = propertiesConfig.getAdminPm25ServiceDir();
        return Paths.get(serviceDir, causality.getName() + UNDER_SCORE + direction.getName(), FILE_NAME);
    }

    @Override
    public String getServicePath() {
        String servicePath = propertiesConfig.getAdminPm25ServicePath();
