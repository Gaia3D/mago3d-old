 ...
 */
@Service
public class SigninNaverServiceImpl implements SigninSocialService {

	private RestTemplate restTemplate;
	private PropertiesConfig propertiesConfig;

	public SigninNaverServiceImpl(PropertiesConfig propertiesConfig, RestTemplate restTemplate) {
