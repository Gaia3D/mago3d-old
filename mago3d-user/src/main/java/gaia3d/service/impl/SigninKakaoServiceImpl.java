...
public class SigninKakaoServiceImpl implements SigninSocialService {
	...
	public SigninKakaoServiceImpl(PropertiesConfig propertiesConfig, RestTemplate restTemplate) {
	...
	public UserInfo socialAuthorize(String authCode) {
		...
		Map responseBody = getSocialUserInfo(restTemplate, accessToken, propertiesConfig.getSocialKakaoUserInfoUri());
