 ...
 * @param {Point3D_} point the point which will be used at this calculate.
 * @param {Point3D_} resultPoint the point which will save the calculated value.
...
/**
 */
Point3D_.mix = function(point_a, point_b, factor, resultPoint) 
{
	if(!resultPoint)
	resultPoint = new Point3D_();
 ...
 */
Point3D_.prototype.getSphericalCoords = function(resultGeographicCoords) 
{
 ...
 */
Point3D_.prototype.getRelativeOrientationToVector = function(vector, radError) 
{
 ...
 */
Point3D_.prototype.angleRadToVector = function(vector) 
{
	if (vector === undefined)
	{ return undefined; }
 ...
 * @returns resultPoint
 */
Point3D_.prototype.angleDegToVector = function(vector) 
{
	if (vector === undefined)
	{ return undefined; }
 ...
 * @returns dx*dx + dy*dy + dz*dz
 */
Point3D_.prototype.isCoincidentToPointCHEAP = function(point, errorDist) 
{
 ...
 * @returns dx*dx + dy*dy + dz*dz
 */
Point3D_.prototype.distToSphere = function(sphere) 
{
 ...
 * @returns dx*dx + dy*dy + dz*dz
 */
Point3D_.prototype.aproxDistTo = function(pointB, sqrtTable) 
{
 ...
 * @param z 변수
 */
Point3D_.prototype.readDataFromBuffer = function(dataArrayBuffer, bytesReaded) 
{
 ...
 * @param z 변수
 */
Point3D_.prototype.scale = function(scaleFactor) 
{
 ...
 * @return {Point3D_}
 */
Point3D_.scale = function(point3d, scaleFactor) 
{
 ...
 * @return {Point3D_}
 */
Point3D_.fromArray = function(array) 
{
	return new Point3D_(array[0], array[1], array[2]);
};
 ...
 * @return {Array<number>}
 */
Point3D_.toArray = function(point3d) 
{
