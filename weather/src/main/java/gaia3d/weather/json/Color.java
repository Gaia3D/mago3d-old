...
public class Color {
     ...
     */
    public static List<Color> mapToList(Map<WindVariable, List<Band>> channelMap) {
        // init bands
     ...
     */
    private static List<Color> merge(List<Band> uBands, List<Band> vBands, List<Band> wBands, int size) {
        List<Color> bands = new ArrayList<>();
